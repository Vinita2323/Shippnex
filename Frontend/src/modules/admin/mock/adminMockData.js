...
export const mockStats = {
  totalUsers: { value: '18,420', change: '+12.5%', isPositive: true },
  ...
  pendingOrders: { value: '142', change: '-5.1%', isPositive: true },
  completedOrders: { value: '1,680', change: '+24.0%', isPositive: true },
  cancelledOrders: { value: '72', change: '-12.0%', isPositive: true },
  todayDeliveries: { value: '1,540', change: '+19.3%', isPositive: true },
  runningDeliveries: { value: '310', change: '+6.5%', isPositive: true },
  lowStockProducts: { value: '28', change: '+2.0%', isPositive: false },
...
export const mockWarehouses = [
  { id: 'WH-01', name: 'Central East Coast Hub', city: 'New York, NY', capacity: '85,000 sq ft', utilization: 82, totalSellers: 140, activeOrders: 310, manager: 'Arthur Pendelton', status: 'Operational' },
  { id: 'WH-02', name: 'West Coast Logistics Terminal', city: 'Los Angeles, CA', capacity: '120,000 sq ft', utilization: 91, totalSellers: 210, activeOrders: 480, manager: 'Linda Zhao', status: 'Operational' },
  { id: 'WH-03', name: 'Midwest Metro Fulfillment', city: 'Chicago, IL', capacity: '65,000 sq ft', utilization: 64, totalSellers: 95, activeOrders: 185, manager: 'Brian O\'Connor', status: 'Operational' },
  { id: 'WH-04', name: 'Southern Cold Storage & Distribution', city: 'Dallas, TX', capacity: '90,000 sq ft', utilization: 78, totalSellers: 115, activeOrders: 240, manager: 'Samantha Ray', status: 'Operational' },
];
